...
import com.projetws.adapter.EtudiantAdapter;
import com.projetws.beans.Etudiant;

public class EtudiantList extends AppCompatActivity {

    private static final String URL_LOAD = "http://192.168.11.225/tpVolleyProjet/ws/loadEtudiant.php";
    private static final String URL_DELETE = "http://192.168.11.225/tpVolleyProjet/controller/deleteEtudiant.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new EtudiantAdapter(this, R.layout.etudiant_item, new ArrayList<>());
        listView.setAdapter(adapter);
        Button addButton = findViewById(R.id.idAddStudentBtn);

        addButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(EtudiantList.this, AddEtudiant.class);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Toast.makeText(EtudiantList.this, R.string.delete_success, Toast.LENGTH_LONG).show();
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(EtudiantList.this, R.string.delete_failed, Toast.LENGTH_LONG).show();
                    }
                }
        );
